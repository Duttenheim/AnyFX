...
/**
*/
VkEffectRenderState::VkEffectRenderState()
{
	// empty
}
...
*/
void
VkEffectRenderState::SetupRasterization(VkPipelineRasterizationStateCreateInfo* info)
{
...
*/
void
VkEffectRenderState::SetupMultisample(VkPipelineMultisampleStateCreateInfo* info)
{
...
*/
void
VkEffectRenderState::SetupDepthStencil(VkPipelineDepthStencilStateCreateInfo* info)
{
...
*/
void
VkEffectRenderState::SetupBlend(VkPipelineColorBlendStateCreateInfo* info)
{
