...
EffectSamplerStreamLoader::Load(BinReader* reader, Effect* effect)
{
	...
	internalSampler->samplerSettings.filterMode =		(FilterMode)reader->ReadInt();
	internalSampler->samplerSettings.addressU =			(AddressMode)reader->ReadInt();
	internalSampler->samplerSettings.addressV =			(AddressMode)reader->ReadInt();
	internalSampler->samplerSettings.addressW =			(AddressMode)reader->ReadInt();
	internalSampler->samplerSettings.comparisonFunc =	(ComparisonFunc)reader->ReadInt();
